...
namespace UniprUtility.Kafka.Abstractions.Clients;
    ...
    where TValue : class
{
    ...
    Task<bool> ConsumeInLoopAsync(string topic, Func<ConsumeResult<TKey, TValue>, Task> comsumerOperationsAsync, CancellationToken cancellationToken = default);
