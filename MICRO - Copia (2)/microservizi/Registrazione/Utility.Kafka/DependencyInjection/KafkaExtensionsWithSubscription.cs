...
using UniprUtility.Kafka.Abstractions.Clients;
using UniprUtility.Kafka.Abstractions.MessageHandlers;
using UniprUtility.Kafka.Clients;
using UniprUtility.Kafka.Services;

namespace Microsoft.Extensions.DependencyInjection;

public static class KafkaExtensionsWithSubscription
{
    /// <summary>
    ...
    /// <returns></returns>
    public static IServiceCollection AddKafkaServicesWithSubscription<TKafkaTopicsInput, TKafkaTopicsOutput, TMessageHandlerFactory, TProducerService>(
        ...
        where TProducerService : ProducerServiceWithSubscription
    {
        ...
        services.AddProducerServiceWithSubscription<TKafkaTopicsOutput, TProducerService>(configuration);
    ...
    /// <param name="configuration"></param>
    /// <returns></returns>
    public static IServiceCollection AddKafkaProducerServiceWithSubscription<TKafkaTopicsOutput, TProducerService>(
        this IServiceCollection services, IConfiguration configuration)
        where TKafkaTopicsOutput : class, IKafkaTopics
        where TProducerService : ProducerServiceWithSubscription
    {
        ...
        where TMessageHandlerFactory : class, IMessageHandlerFactory<string, string>
    {
        ...
        services.AddSingleton<IMessageHandlerFactory<string, string>, TMessageHandlerFactory>();
        ...
        // ConsumerClient
        services.AddSingleton<IConsumerClient<string, string>, ConsumerClient>();
        ...
        where TProducerService : ProducerServiceWithSubscription
    {
        ...
        // ProducerClient
        services.AddSingleton<IProducerClient<string, string>, ProducerClient>();
