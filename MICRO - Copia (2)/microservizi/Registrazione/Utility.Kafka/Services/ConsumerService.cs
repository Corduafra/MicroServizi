...
namespace UniprUtility.Kafka.Services;

public class ConsumerService<TKafkaTopics>(ILogger<ConsumerService<TKafkaTopics>> logger, IConsumerClient<string, string> consumerClient, IAdministatorClient adminClient, IOptions<TKafkaTopics> optionsTopics, IServiceScopeFactory serviceScopeFactory, IMessageHandlerFactory<string, string> messageHandlerFactory) : BackgroundService
    where TKafkaTopics : class, IKafkaTopics {
